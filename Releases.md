...
This release is a technology preview release intended to provide end users with a stable version of inavsuite + dashboard.
...
Please note.  The official latest release that aligns with the 2.2.x firmware does not include dashboard.  This snapshot is to the best of our knowledge stable - however bugs may still occur.  If you are not happy to use a snapshot version - please use the official 2.2.x release of inavsuite.
...
Release version for 2.2.0 Inav
...
Release candidate version for 2.2.0-RC5 Inav
...
Release candidate version for 2.2.0-RC4 Inav
...
Release candidate version for 2.2.0-RC3 Inav
...
Release candidate version for 2.2.0-RC1 Inav
...
(https://github.com/rotorflight/inav-lua-ethos-suite/tree/release/2.2.0-RC1).

## Downloads

The download locations are:

- [Inav Configurator](https://github.com/rotorflight/rotorflight-configurator/releases/tag/release/2.2.0-RC1)
- [Inav Blackbox](https://github.com/rotorflight/rotorflight-blackbox/releases/tag/release/2.2.0-RC1)
...
- [Lua Suite for FrSky Ethos](https://github.com/rotorflight/inav-lua-ethos-suite/releases/tag/release/2.2.0-RC1)

***

# 2.1.1

Release version for 2.1.1 Inav
...
For instructions and other details, please read the [README]
(https://github.com/rotorflight/inav-lua-ethos-suite/tree/release/2.1.1).

## Downloads

The download locations are:

- [Inav Configurator](https://github.com/rotorflight/rotorflight-configurator/releases/tag/release/2.1.1)
- [Inav Blackbox](https://github.com/rotorflight/rotorflight-blackbox/releases/tag/release/2.1.1)
...
- [Lua Suite for FrSky Ethos](https://github.com/rotorflight/inav-lua-ethos-suite/releases/tag/release/2.1.1)

***

# 2.1.0

Release version for 2.1.0 Inav
...
For instructions and other details, please read the [README]
(https://github.com/rotorflight/inav-lua-ethos-suite/tree/release/2.1.0).

## Downloads

The download locations are:

- [Inav Configurator](https://github.com/rotorflight/rotorflight-configurator/releases/tag/release/2.1.0)
- [Inav Blackbox](https://github.com/rotorflight/rotorflight-blackbox/releases/tag/release/2.1.0)
...
- [Lua Suite for FrSky Ethos](https://github.com/rotorflight/inav-lua-ethos-suite/releases/tag/release/2.1.0)

***

# 2.1.0-RC2

This is the _second Release Candidate_ of the Inav 2.1 RFSUITE LUA Scripts for FrSky Ethos.
...
This is the _first Release Candidate_ of the Inav 2.1 RFSUITE LUA Scripts for FrSky Ethos.

## Instructions

For instructions and other details, please read the [README]
(https://github.com/rotorflight/inav-lua-ethos-suite/tree/release/2.1.0-RC1).

## Downloads

The download locations are:

- [Inav Configurator](https://github.com/rotorflight/rotorflight-configurator/releases/tag/release/2.1.0-RC1)
- [Inav Blackbox](https://github.com/rotorflight/rotorflight-blackbox/releases/tag/release/2.1.0-RC1)
...
- [Lua Suite for FrSky Ethos](https://github.com/rotorflight/inav-lua-ethos-suite/releases/tag/release/2.1.0-RC1)
...
The main source of Inav information and instructions is now the [website](https://www.rotorflight.org/).
Inav has a strong presence on the Discord platform - you can join us [here](https://discord.gg/FyfMF4RwSA/).
...
There is also a [Inav Facebook Group](https://www.facebook.com/groups/876445460825093) for hanging out with other Inav pilots.