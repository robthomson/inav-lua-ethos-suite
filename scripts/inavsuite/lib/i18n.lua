...
local function loadLangFile(filepath)
  if inavsuite.utils and inavsuite.tasks and inavsuite.tasks.logger then
    inavsuite.utils.log("i18n: loading language file " .. filepath,"info")
  end
...
function i18n.evict()
  if translations then
    if inavsuite.utils and inavsuite.tasks and inavsuite.tasks.logger then
      inavsuite.utils.log("i18n: evicting language file to save memory","info")
    end
    translations = nil
