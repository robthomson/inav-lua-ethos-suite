    ...
    app.dialogs.progress = form.openProgressDialog({
        ...
        wakeup  = function()
            ...
            if not app.triggers.closeProgressLoader then
                ...
                if app.dialogs.progressCounter > 50 and inavsuite.session.apiVersion and not utils.stringInArray(inavsuite.config.supportedMspApiVersion, apiV) then
...
function ui.openPage(idx, title, script, extra1, extra2, extra3, extra5, extra6)
    ...
    app.Page = assert(inavsuite.compiler.loadfile(modulePath))(idx)
