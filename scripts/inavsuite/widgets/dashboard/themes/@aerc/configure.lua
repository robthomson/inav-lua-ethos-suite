...
local function configure()
    ...
    -- RPM PANEL
    local rpm_panel = form.addExpansionPanel(inavsuite.i18n.get("widgets.dashboard.headspeed"))
    rpm_panel:open(false)
    local rpm_min_line = rpm_panel:addLine(inavsuite.i18n.get("widgets.dashboard.min"))
    ...
    local rpm_max_line = rpm_panel:addLine(inavsuite.i18n.get("widgets.dashboard.max"))
    ...
    -- BEC VOLTAGE PANEL
    local bec_panel = form.addExpansionPanel(inavsuite.i18n.get("widgets.dashboard.bec_voltage"))
    bec_panel:open(false)
    local bec_min_line = bec_panel:addLine(inavsuite.i18n.get("widgets.dashboard.min"))
    ...
    local bec_warn_line = bec_panel:addLine(inavsuite.i18n.get("widgets.dashboard.warning"))
    ...
    local bec_max_line = bec_panel:addLine(inavsuite.i18n.get("widgets.dashboard.max"))
    ...
    -- ESC TEMP PANEL
    local esc_panel = form.addExpansionPanel(inavsuite.i18n.get("widgets.dashboard.esc_temp"))
    esc_panel:open(false)
    local esc_warn_line = esc_panel:addLine(inavsuite.i18n.get("widgets.dashboard.warning"))
    ...
    local esc_max_line = esc_panel:addLine(inavsuite.i18n.get("widgets.dashboard.max"))
