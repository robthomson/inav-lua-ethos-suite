...
local function configure()
    inavsuite.utils.log("configure dashboard theme","info")
    activateWakeup = true

    config.setting1 = inavsuite.widgets.dashboard.getPreference("setting1") or 0
...
local function write()
    ...
    for i,v in pairs(config) do
        inavsuite.widgets.dashboard.savePreference(i, v)
    end
end
