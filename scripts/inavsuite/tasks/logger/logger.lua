...
-- 
-- This script initializes the logging configuration for the inavsuite module.
-- 
...
-- 
-- The minimum print level for logging is set from `inavsuite.preferences.developer.loglevel`.
-- 
...
os.mkdir("LOGS:/inavsuite/logs")
logger.queue = assert(inavsuite.compiler.loadfile("tasks/logger/lib/log.lua"))(config)
logger.queue.config.log_file = "LOGS:/inavsuite/logs/rfsuite_" .. os.date("%Y-%m-%d_%H-%M-%S") .. ".log"
logger.queue.config.min_print_level  = inavsuite.preferences.developer.loglevel
local logtofile = inavsuite.preferences.developer.logtofile
