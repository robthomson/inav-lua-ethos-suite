...
local function configure()
    ...
    local rpm_min_line = rpm_panel:addLine(inavsuite.i18n.get("widgets.dashboard.max"))
    ...
    -- VOLTAGE PANEL
    local voltage_panel = form.addExpansionPanel(inavsuite.i18n.get("widgets.dashboard.voltage"))
    voltage_panel:open(false)
    local voltage_min_line = voltage_panel:addLine(inavsuite.i18n.get("widgets.dashboard.min"))
    ...
    local voltage_max_line = voltage_panel:addLine(inavsuite.i18n.get("widgets.dashboard.max"))
