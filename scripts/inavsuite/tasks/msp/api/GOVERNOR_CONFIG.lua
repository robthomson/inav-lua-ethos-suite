...
if inavsuite.utils.apiVersionCompare(">=", "12.09") then
    ...
    local gov_modeTable ={[0] = inavsuite.i18n.get("api.GOVERNOR_CONFIG.tbl_govmode_off"), inavsuite.i18n.get("api.GOVERNOR_CONFIG.tbl_govmode_external"), inavsuite.i18n.get("api.GOVERNOR_CONFIG.tbl_govmode_electric"), inavsuite.i18n.get("api.GOVERNOR_CONFIG.tbl_govmode_nitro")}
    local throttleTypeTable ={[0] = inavsuite.i18n.get("api.GOVERNOR_CONFIG.tbl_throttle_type_normal"), inavsuite.i18n.get("api.GOVERNOR_CONFIG.tbl_throttle_type_off_on"),inavsuite.i18n.get("api.GOVERNOR_CONFIG.tbl_throttle_type_off_idle_on"),inavsuite.i18n.get("api.GOVERNOR_CONFIG.tbl_throttle_type_idle_auto_on")}
    ...
    local gov_modeTable ={[0] = inavsuite.i18n.get("api.GOVERNOR_CONFIG.tbl_govmode_off"), inavsuite.i18n.get("api.GOVERNOR_CONFIG.tbl_govmode_passthrough"), inavsuite.i18n.get("api.GOVERNOR_CONFIG.tbl_govmode_standard"), inavsuite.i18n.get("api.GOVERNOR_CONFIG.tbl_govmode_mode1"), inavsuite.i18n.get("api.GOVERNOR_CONFIG.tbl_govmode_mode2")}
