...
local flightMode = {inavsuite.i18n.get("api.ESC_PARAMETERS_XDFLY.tbl_fmheli"), inavsuite.i18n.get("api.ESC_PARAMETERS_XDFLY.tbl_fmfw")}
local motorDirection = {inavsuite.i18n.get("api.ESC_PARAMETERS_XDFLY.tbl_cw"), inavsuite.i18n.get("api.ESC_PARAMETERS_XDFLY.tbl_ccw")}
local becLvVoltage = {"6.0V", "7.4V","8.4V"}
local startupPower = {inavsuite.i18n.get("api.ESC_PARAMETERS_XDFLY.tbl_low"), inavsuite.i18n.get("api.ESC_PARAMETERS_XDFLY.tbl_medium"), inavsuite.i18n.get("api.ESC_PARAMETERS_XDFLY.tbl_high")}
local fanControl = {inavsuite.i18n.get("api.ESC_PARAMETERS_XDFLY.tbl_on"), inavsuite.i18n.get("api.ESC_PARAMETERS_XDFLY.tbl_off")}
local ledColor = {inavsuite.i18n.get("api.ESC_PARAMETERS_XDFLY.tbl_red"), inavsuite.i18n.get("api.ESC_PARAMETERS_XDFLY.tbl_yellow"),inavsuite.i18n.get("api.ESC_PARAMETERS_XDFLY.tbl_orange"),inavsuite.i18n.get("api.ESC_PARAMETERS_XDFLY.tbl_green"),inavsuite.i18n.get("api.ESC_PARAMETERS_XDFLY.tbl_jadegreen"),inavsuite.i18n.get("api.ESC_PARAMETERS_XDFLY.tbl_blue"),inavsuite.i18n.get("api.ESC_PARAMETERS_XDFLY.tbl_cyan"),inavsuite.i18n.get("api.ESC_PARAMETERS_XDFLY.tbl_purple"),inavsuite.i18n.get("api.ESC_PARAMETERS_XDFLY.tbl_pink"),inavsuite.i18n.get("api.ESC_PARAMETERS_XDFLY.tbl_white")}
...
local lowVoltage = {inavsuite.i18n.get("api.ESC_PARAMETERS_XDFLY.tbl_off"), "2.7V", "3.0V", "3.2V", "3.4V", "3.6V", "3.8V"}
local timing = {inavsuite.i18n.get("api.ESC_PARAMETERS_XDFLY.tbl_auto"), inavsuite.i18n.get("api.ESC_PARAMETERS_XDFLY.tbl_low"), inavsuite.i18n.get("api.ESC_PARAMETERS_XDFLY.tbl_medium"), inavsuite.i18n.get("api.ESC_PARAMETERS_XDFLY.tbl_high")}
local accel = {inavsuite.i18n.get("api.ESC_PARAMETERS_XDFLY.tbl_fast"), inavsuite.i18n.get("api.ESC_PARAMETERS_XDFLY.tbl_normal"), inavsuite.i18n.get("api.ESC_PARAMETERS_XDFLY.tbl_slow"), inavsuite.i18n.get("api.ESC_PARAMETERS_XDFLY.tbl_vslow")}
local brakeType = {inavsuite.i18n.get("api.ESC_PARAMETERS_XDFLY.tbl_normal"), inavsuite.i18n.get("api.ESC_PARAMETERS_XDFLY.tbl_reverse")}
local autoRestart = {inavsuite.i18n.get("api.ESC_PARAMETERS_XDFLY.tbl_off"), "90s"}
local srFunc = {inavsuite.i18n.get("api.ESC_PARAMETERS_XDFLY.tbl_on"), inavsuite.i18n.get("api.ESC_PARAMETERS_XDFLY.tbl_off")}
local govMode = {inavsuite.i18n.get("api.ESC_PARAMETERS_XDFLY.tbl_escgov"), inavsuite.i18n.get("api.ESC_PARAMETERS_XDFLY.tbl_extgov") , inavsuite.i18n.get("api.ESC_PARAMETERS_XDFLY.tbl_fwgov")}
