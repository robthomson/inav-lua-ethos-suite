...
local escMode = {inavsuite.i18n.get("api.ESC_PARAMETERS_SCORPION.tbl_heligov"), inavsuite.i18n.get("api.ESC_PARAMETERS_SCORPION.tbl_helistore"), inavsuite.i18n.get("api.ESC_PARAMETERS_SCORPION.tbl_vbargov"), inavsuite.i18n.get("api.ESC_PARAMETERS_SCORPION.tbl_extgov"), inavsuite.i18n.get("api.ESC_PARAMETERS_SCORPION.tbl_airplane"), inavsuite.i18n.get("api.ESC_PARAMETERS_SCORPION.tbl_boat"), inavsuite.i18n.get("api.ESC_PARAMETERS_SCORPION.tbl_quad")}
local rotation = {inavsuite.i18n.get("api.ESC_PARAMETERS_SCORPION.tbl_ccw"), inavsuite.i18n.get("api.ESC_PARAMETERS_SCORPION.tbl_cw")}
local becVoltage = {"5.1 V", "6.1 V", "7.3 V", "8.3 V", "Disabled"}
local teleProtocol = {inavsuite.i18n.get("api.ESC_PARAMETERS_SCORPION.tbl_standard"), inavsuite.i18n.get("api.ESC_PARAMETERS_SCORPION.tbl_vbar"), inavsuite.i18n.get("api.ESC_PARAMETERS_SCORPION.tbl_exbus"), inavsuite.i18n.get("api.ESC_PARAMETERS_SCORPION.tbl_unsolicited"), inavsuite.i18n.get("api.ESC_PARAMETERS_SCORPION.tbl_futsbus")}
local onOff = {inavsuite.i18n.get("api.ESC_PARAMETERS_SCORPION.tbl_on"), inavsuite.i18n.get("api.ESC_PARAMETERS_SCORPION.tbl_off")}
