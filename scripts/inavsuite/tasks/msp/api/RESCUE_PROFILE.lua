...
local MSP_API_STRUCTURE_READ_DATA = {
    {field = "rescue_mode",               type = "U8",  apiVersion = 12.06, simResponse = {1},   min = 0, max = 1,   default = 0,   table = {[0] = inavsuite.i18n.get("api.RESCUE_PROFILE.tbl_off"), inavsuite.i18n.get("api.RESCUE_PROFILE.tbl_on")}},
    {field = "rescue_flip_mode",          type = "U8",  apiVersion = 12.06, simResponse = {0},   min = 0, max = 1,   default = 0,   table = {[0] = inavsuite.i18n.get("api.RESCUE_PROFILE.tbl_noflip"), inavsuite.i18n.get("api.RESCUE_PROFILE.tbl_flip")}},
