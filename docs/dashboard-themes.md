...
This document provides a complete technical reference for creating, customizing, and extending dashboard themes in Inav. It covers theme structure, lifecycle hooks, box definitions, object types and subtypes (from the `objects` library), common properties, positioning/sizing, styling, interactivity, and examples.

---

## 1. Directory & File Structure

Inav dashboard themes and objects are organized under:

```
<SCRIPTS>/inavsuite/widgets/dashboard/
...
* **System**: `SCRIPTS:inavsuite/widgets/dashboard/themes/<themename>/`
* **User**:   `SCRIPTS:inavsuite.user/dashboard/<themename>/`
...
| `apiversion` | Shows Inav API version (auto).  | –                 |
