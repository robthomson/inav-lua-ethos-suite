...
function timer.wakeup()
    local prefs = inavsuite.preferences.timer or {}
    ...
    if elapsed >= targetSeconds then
        if not triggered then
            ...
            elseif elapsedMode == 1 then
                inavsuite.utils.playFileCommon("multibeep.wav")
            elseif elapsedMode == 2 then
                inavsuite.utils.playFile("events", "alerts/elapsed.wav")
            elseif elapsedMode == 3 then
                inavsuite.utils.playFile("status", "alerts/timer.wav")
