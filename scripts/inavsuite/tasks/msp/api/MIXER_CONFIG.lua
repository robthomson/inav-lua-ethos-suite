...
local MSP_API_STRUCTURE_READ_DATA = {
    {field = "main_rotor_dir",                 type = "U8",  apiVersion = 12.06, simResponse = {0}, table={inavsuite.i18n.get("api.MIXER_CONFIG.tbl_cw"),inavsuite.i18n.get("api.MIXER_CONFIG.tbl_ccw")}, tableIdxInc = -1},
