...
local function openPage(pageIdx, title, script)
    ...
    local saved = inavsuite.preferences.timer or {}
    ...
    inavsuite.app.formLines[inavsuite.app.formLineCnt] = form.addLine(i18n("app.modules.settings.timer_alerting"))
    inavsuite.app.formFields[formFieldCount] = form.addBooleanField(
        inavsuite.app.formLines[inavsuite.app.formLineCnt], nil,
        function() return config.timeraudioenable or false end,
        function(newValue)
            config.timeraudioenable = newValue
            inavsuite.app.formFields[idxChoice]:enable(newValue)
            inavsuite.app.formFields[idxPre]:enable(newValue)
            inavsuite.app.formFields[idxPost]:enable(newValue)
            inavsuite.app.formFields[idxPrePeriod]:enable(newValue and (config.prealerton or false))
            inavsuite.app.formFields[idxPreInterval]:enable(newValue and (config.prealerton or false))
            inavsuite.app.formFields[idxPostPeriod]:enable(newValue and (config.postalerton or false))
            inavsuite.app.formFields[idxPostInterval]:enable(newValue and (config.postalerton or false))
        end
    )
    ...
    formFieldCount = formFieldCount + 1
    inavsuite.app.formLineCnt = inavsuite.app.formLineCnt + 1
    inavsuite.app.formLines[inavsuite.app.formLineCnt] = form.addLine(i18n("app.modules.settings.timer_elapsed_alert_mode"))
    ...
    inavsuite.app.formFields[formFieldCount] = form.addBooleanField(
        ...
        function(newValue)
            ...
            inavsuite.app.formFields[idxPrePeriod]:enable(audioEnabled and newValue)
            inavsuite.app.formFields[idxPreInterval]:enable(audioEnabled and newValue)
        end
    )
    ...
    inavsuite.app.formFields[formFieldCount]:enable((config.timeraudioenable or false) and (config.prealerton or false))
    ...
    inavsuite.app.formFields[formFieldCount] = form.addBooleanField(
        ...
        function(newValue)
            ...
            local audioEnabled = config.timeraudioenable or false
            inavsuite.app.formFields[idxPostPeriod]:enable(audioEnabled and newValue)
            inavsuite.app.formFields[idxPostInterval]:enable(audioEnabled and newValue)
        end
    )
    ...
    inavsuite.app.formFields[formFieldCount]:enable((config.timeraudioenable or false) and (config.postalerton or false))
    ...
    inavsuite.app.formFields[idxChoice]:enable(config.timeraudioenable or false)
    inavsuite.app.formFields[idxPre]:enable(config.timeraudioenable or false)
    inavsuite.app.formFields[idxPrePeriod]:enable((config.timeraudioenable or false) and (config.prealerton or false))
    inavsuite.app.formFields[idxPreInterval]:enable((config.timeraudioenable or false) and (config.prealerton or false))
    inavsuite.app.formFields[idxPost]:enable(config.timeraudioenable or false)
    inavsuite.app.formFields[idxPostPeriod]:enable((config.timeraudioenable or false) and (config.postalerton or false))
    inavsuite.app.formFields[idxPostInterval]:enable((config.timeraudioenable or false) and (config.postalerton or false))
    ...
    local buttons = {
        {
            ...
            action = function()
                ...
                for key, value in pairs(config) do
                    inavsuite.preferences.timer[key] = value
                end
