...
local escMode = {inavsuite.i18n.get("api.ESC_PARAMETERS_YGE.tbl_modefree"), inavsuite.i18n.get("api.ESC_PARAMETERS_YGE.tbl_modeext"), inavsuite.i18n.get("api.ESC_PARAMETERS_YGE.tbl_modeheli"), inavsuite.i18n.get("api.ESC_PARAMETERS_YGE.tbl_modestore"), inavsuite.i18n.get("api.ESC_PARAMETERS_YGE.tbl_modeglider"), inavsuite.i18n.get("api.ESC_PARAMETERS_YGE.tbl_modeair"), inavsuite.i18n.get("api.ESC_PARAMETERS_YGE.tbl_modef3a")}
local direction = {inavsuite.i18n.get("api.ESC_PARAMETERS_YGE.tbl_normal"), inavsuite.i18n.get("api.ESC_PARAMETERS_YGE.tbl_reverse")}
local cuttoff = {inavsuite.i18n.get("api.ESC_PARAMETERS_YGE.tbl_off"), inavsuite.i18n.get("api.ESC_PARAMETERS_YGE.tbl_slowdown"), inavsuite.i18n.get("api.ESC_PARAMETERS_YGE.tbl_cutoff")}
local cuttoffVoltage = {"2.9 V", "3.0 V", "3.1 V", "3.2 V", "3.3 V", "3.4 V"}
local offOn = {inavsuite.i18n.get("api.ESC_PARAMETERS_YGE.tbl_off"), inavsuite.i18n.get("api.ESC_PARAMETERS_YGE.tbl_on")}
local startupResponse = {inavsuite.i18n.get("api.ESC_PARAMETERS_YGE.tbl_normal"), inavsuite.i18n.get("api.ESC_PARAMETERS_YGE.tbl_smooth")}
local throttleResponse = {inavsuite.i18n.get("api.ESC_PARAMETERS_YGE.tbl_slow"), inavsuite.i18n.get("api.ESC_PARAMETERS_YGE.tbl_medium"), inavsuite.i18n.get("api.ESC_PARAMETERS_YGE.tbl_fast"), inavsuite.i18n.get("api.ESC_PARAMETERS_YGE.tbl_custom")}
local motorTiming = {inavsuite.i18n.get("api.ESC_PARAMETERS_YGE.tbl_autonorm"), inavsuite.i18n.get("api.ESC_PARAMETERS_YGE.tbl_autoefficient"), inavsuite.i18n.get("api.ESC_PARAMETERS_YGE.tbl_autopower"), inavsuite.i18n.get("api.ESC_PARAMETERS_YGE.tbl_autoextreme"), "0°", "6°", "12°", "18°", "24°", "30°"}
local motorTimingToUI = {0, 4, 5, 6, 7, 8, 9, [16] = 0, [17] = 1, [18] = 2, [19] = 3}
local motorTimingFromUI = {0, 17, 18, 19, 1, 2, 3, 4, 5, 6}
local freewheel = {inavsuite.i18n.get("api.ESC_PARAMETERS_YGE.tbl_off"), inavsuite.i18n.get("api.ESC_PARAMETERS_YGE.tbl_auto"), inavsuite.i18n.get("api.ESC_PARAMETERS_YGE.tbl_unused"), inavsuite.i18n.get("api.ESC_PARAMETERS_YGE.tbl_alwayson")}
