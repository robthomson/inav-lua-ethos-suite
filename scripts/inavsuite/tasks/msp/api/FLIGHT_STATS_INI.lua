...
local ini       = inavsuite.ini
local mspModule = inavsuite.tasks.msp.api
...
local function write()
    ...
    for k, v in pairs(payloadData) do
        ...
        -- update session data
        if inavsuite.session.modelPreferences and inavsuite.session.modelPreferences[INI_SECTION] then
            inavsuite.session.modelPreferences[INI_SECTION][k] = v
        end
    end
