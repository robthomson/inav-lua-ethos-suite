...
sections[#sections + 1] = {
    title = inavsuite.i18n.get("app.modules.pids.name"),
    module = "pids",
    script = "pids.lua",
    image = "app/modules/pids/pids.png",
}
sections[#sections + 1] = {
    title = inavsuite.i18n.get("app.modules.rates.name"),
    module = "rates",
    script = "rates.lua",
    image = "app/modules/rates/rates.png",
}
sections[#sections + 1] = {
    title = inavsuite.i18n.get("app.modules.profile_governor.name"),
    module = "profile_governor",
    script = "select.lua",
    image = "app/modules/profile_governor/governor.png",
}
sections[#sections + 1] = {
    title = inavsuite.i18n.get("app.modules.profile_tailrotor.name"),
    module = "tailrotor",
...
sections[#sections + 1] = {
    title = inavsuite.i18n.get("app.modules.logs.name"),
    offline = true,
    module = "logs",
    script = "logs_dir.lua",
...
sections[#sections + 1] = {
    title = inavsuite.i18n.get("app.modules.settings.name"),
    offline = true,
    module = "settings",
    script = "settings.lua",
...
sections[#sections + 1] = {
    title = inavsuite.i18n.get("app.modules.diagnostics.name"),
    module = "diagnostics",
