...
function telemetryconfig.wakeup()
    ...
    if (inavsuite.session.telemetryConfig == nil) and (mspCallMade == false) then
        ...
        API.setCompleteHandler(function(self, buf)
            ...
            if inavsuite.utils and inavsuite.utils.log then
                inavsuite.utils.log("Updated telemetry sensors: " .. slotsStr, "info")
            end
        end)
...
function telemetryconfig.isComplete()
    if inavsuite.session.telemetryConfig ~= nil then
        return true
    end
end
