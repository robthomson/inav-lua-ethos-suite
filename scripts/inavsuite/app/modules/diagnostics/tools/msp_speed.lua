...
local function openPage(pidx, title, script)
    ...
    inavsuite.app.formNavigationFields['menu'] = form.addButton(line, {x = x - 5 - buttonW - buttonWs, y = inavsuite.app.radio.linePaddingTop, w = buttonW, h = inavsuite.app.radio.navbuttonHeight}, {
    ...
    -- ACTION BUTTON
    inavsuite.app.formNavigationFields['tool'] = form.addButton(line, {x = x - buttonWs, y = inavsuite.app.radio.linePaddingTop, w = buttonWs, h = inavsuite.app.radio.navbuttonHeight}, {
        text = "*",
        icon = nil,
        options = FONT_S,
        press = function()
