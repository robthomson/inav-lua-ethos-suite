...
function render.wakeup(box)
    -- Read current count
    local value
    if inavsuite.session and inavsuite.session.modelPreferences then
        value =  inavsuite.ini.getvalue(inavsuite.session.modelPreferences, "general", "flightcount")
        lastValue = value
    else
    ...
    local telemetryActive = inavsuite.session and inavsuite.session.isConnected
