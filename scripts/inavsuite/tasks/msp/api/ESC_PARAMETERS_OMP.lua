...
local flightMode = {inavsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_fmheli"), inavsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_fmfw")}
local motorDirection = {inavsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_cw"), inavsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_ccw")}
local becLvVoltage = {"6.0V", "7.4V","8.4V"}
local startupPower = {inavsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_low"), inavsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_medium"), inavsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_high")}
local fanControl = {inavsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_on"), inavsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_off")}
local ledColor = {inavsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_red"), inavsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_yellow"),inavsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_orange"),inavsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_green"),inavsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_jadegreen"),inavsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_blue"),inavsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_cyan"),inavsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_purple"),inavsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_pink"),inavsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_white")}
...
local lowVoltage = {inavsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_off"), "2.7V", "3.0V", "3.2V", "3.4V", "3.6V", "3.8V"}
local timing = {inavsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_auto"), inavsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_low"), inavsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_medium"), inavsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_high")}
local accel = {inavsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_fast"), inavsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_normal"), inavsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_slow"), inavsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_vslow")}
local brakeType = {inavsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_normal"), inavsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_reverse")}
local autoRestart = {inavsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_off"), "90s"}
local srFunc = {inavsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_on"), inavsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_off")}
local govMode = {inavsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_escgov"), inavsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_extgov") , inavsuite.i18n.get("api.ESC_PARAMETERS_OMP.tbl_fwgov")}
