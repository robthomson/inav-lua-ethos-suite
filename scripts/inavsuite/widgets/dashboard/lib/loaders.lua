...
local function drawLogoImage(cx, cy, w, h)
  local imageName = "SCRIPTS:/" .. inavsuite.config.baseDir .. "/widgets/dashboard/gfx/logo.png"
  local bmp = inavsuite.utils.loadImage(imageName)
  if bmp then
...
local function renderOverlayText(dashboard, cx, cy, innerR, fg)
  local message = dashboard._overlay_text or inavsuite.i18n.get("widgets.dashboard.loading")
