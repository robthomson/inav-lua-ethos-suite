...
# Require config path from INAVSUITE_CONFIG env var
CONFIG_PATH = os.environ.get('INAVSUITE_CONFIG')

if not CONFIG_PATH:
    print("[CONFIG ERROR] Environment variable INAVSUITE_CONFIG is not set.")
    sys.exit(1)
