...
local function customWakeupFunction()
   -- inavsuite.utils.log("Custom wakeup function called", "info")
end
...
local function onpressFunctionSave()
    ...
    inavsuite.utils.log("Saving value to model preferences: " .. value, "info")

    inavsuite.utils.log("Reading value from model preferences", "info")
    local readValue = inavsuite.widgets.dashboard.getPreference(key)
    inavsuite.utils.log("Value read from model preferences: " .. tostring(readValue), "info")
end
