...
local gyroFilterType = {[0]=inavsuite.i18n.get("api.FILTER_CONFIG.tbl_none"), [1]=inavsuite.i18n.get("api.FILTER_CONFIG.tbl_1st"), [2]=inavsuite.i18n.get("api.FILTER_CONFIG.tbl_2nd")}
local rpmPreset = {inavsuite.i18n.get("api.FILTER_CONFIG.tbl_custom"),inavsuite.i18n.get("api.FILTER_CONFIG.tbl_low"), inavsuite.i18n.get("api.FILTER_CONFIG.tbl_medium"), inavsuite.i18n.get("api.FILTER_CONFIG.tbl_high")}
