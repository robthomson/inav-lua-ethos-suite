...
local function wakeup()
  ...
  do
    ...
    if field then
      field:value(string.format("%.1f%%", inavsuite.performance.cpuload or 0))
    end
  end
  ...
  do
    ...
    if field then
      field:value(string.format("%.1f kB", inavsuite.utils.round(inavsuite.performance.freeram or 0, 1)))
    end
  end
