...
local function openPage(pageIdx, title, script)
    ...
    local eventList = inavsuite.tasks.events.telemetry.eventTable
    local eventNames = sensorNameMap(inavsuite.tasks.telemetry.listSensors())

    -- Prepare working config as a shallow copy of events preferences
    local savedEvents = inavsuite.preferences.events or {}
    ...
    inavsuite.app.formFields[formFieldCount] = form.addBooleanField(
        ...
        function(val)
            config.temp_esc = val
            setFieldEnabled(inavsuite.app.formFields[escFields.thresh], val)
        end
    )
    ...
    inavsuite.app.formFields[formFieldCount] = form.addNumberField(
        escThresh, nil, 60, 300,
        function() return config.escalertvalue or 90 end,
        function(val) config.escalertvalue = val end,
        1
    )
    inavsuite.app.formFields[formFieldCount]:suffix("°")
    setFieldEnabled(inavsuite.app.formFields[escFields.thresh], escEnabled)
    ...
    inavsuite.app.formFields[formFieldCount] = form.addBooleanField(
        ...
        function(val)
            ...
            setFieldEnabled(inavsuite.app.formFields[fuelFields.callout], val)
            setFieldEnabled(inavsuite.app.formFields[fuelFields.repeats], val)
            setFieldEnabled(inavsuite.app.formFields[fuelFields.haptic], val)
        end
    )
    ...
    setFieldEnabled(inavsuite.app.formFields[fuelFields.callout], fuelEnabled)
    ...
    inavsuite.app.formFields[formFieldCount]:suffix("x")
    setFieldEnabled(inavsuite.app.formFields[fuelFields.repeats], fuelEnabled)
    ...
    setFieldEnabled(inavsuite.app.formFields[fuelFields.haptic], fuelEnabled)

    setFieldEnabled(inavsuite.app.formFields[escFields.enable], true)
    setFieldEnabled(inavsuite.app.formFields[becFields.enable], true)
    setFieldEnabled(inavsuite.app.formFields[fuelFields.enable], true)
    ...
    local buttons = {
        {
            ...
            action = function()
                ...
                for key, value in pairs(config) do
                    inavsuite.preferences.events[key] = value
                end
