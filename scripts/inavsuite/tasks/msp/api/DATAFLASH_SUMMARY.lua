...
local API_NAME = "DATAFLASH_SUMMARY" -- API name (must be same as filename)
local MSP_API_CMD_READ = 70 -- Command identifier for MSP Mixer Config Read
local MSP_API_CMD_WRITE = nil -- Command identifier for saving Mixer Config Settings
