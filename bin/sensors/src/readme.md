# Rotorflight inavsuite Sensor Updater

This folder contains the Python GUI script and build tools for generating a standalone Windows executable for updating simulated sensor values used in Rotorflight inavsuite testing.
...
- Path to the root of the Rotorflight inavsuite source repo.
- Must contain:
...
## 📄 License
This project is part of Rotorflight inavsuite. For licensing details, refer to the upstream repository.
