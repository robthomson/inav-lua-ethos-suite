...
local API_NAME = "FLIGHT_STATS" -- API name (must be same as filename)
local MSP_API_CMD_READ = 14 -- Command identifier 
local MSP_API_CMD_WRITE = 15 -- Command identifier 
