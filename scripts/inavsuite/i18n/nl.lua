...
return {
  ...
  ["api"] = {
    ...
    ["GOVERNOR_CONFIG"] = {
      ...
      ["tbl_throttle_type_normal"] = "NORMAAL",
      ["tbl_throttle_type_off_on"] = "UIT_AAN",
      ["tbl_throttle_type_off_idle_on"] = "UIT_STATIONAIR_AAN",
      ["tbl_throttle_type_idle_auto_on"] = "STATIONAIR_AUTO_AAN",
      ["governor_idle_throttle"] = "Stationair throttle",
      ["governor_auto_throttle"] = "Automatische throttle",
      ["governor_fallback_drop"] = "Terugvalverlaging"
    },
    ["RC_CONFIG"] = {
  ...
  ["app"] = {
    ...
    ["modules"] = {
      ["diagnostics"] = {
        ["name"] = "Diagnostiek",
        ["help_p1"] = "Deze module biedt diverse tools om problemen met uw vliegcontroller of configuratie te diagnosticeren."
      },
      ["stats"] = {
        ["name"] = "Status",
      ...
      ["settings"] = {
        ...
        ["txt_logging"] = "Loggen",
        ["txt_objectprofiler"] = "Log dashboard-snelheid",
      ...
      ["profile_governor"] = {
        ["tail_torque_assist"] = "Staart Koppel Assistent",
        ["fc_throttle_curve"] = "FC Gas Kromme",
        ["tx_precomp_curve"] = "TX Precomp Kromme",
        ["fallback_precomp"] = "Terugval Precomp",
        ["voltage_comp"] = "Spanning Comp",
        ["pid_spoolup"] = "PID Optoeren",
        ["hs_adjustment"] = "HS Aanpassing",
        ["dyn_min_throttle"] = "Dyn. Min Gas",
        ...
        ["idle_throttle"] = "Stationair gas",
        ["auto_throttle"] = "Automatisch gas",
        ["fallback_drop"] = "Gas terugval",
      ...
      ["governor"] = {
        ...
        ["idle_collective"] = "Stationair collectief",
        ["wot_collective"] = "Volgas collectief",
        ["throttle_hold_timeout"] = "Throttle hold tijdslimiet",
        ["ramp_time"] = "Ramp tijd",
        ["startup_time"] = "Opstarttijd",
        ["spoolup_time"] = "Optoer tijd",
        ["spooldown_time"] = "Aftoer tijd",
        ["tracking_time"] = "Tracking time",
        ["help_p2"] = "Elke parameter is een tijdswaarde in seconden voor elke governor actie.\n\n",
        ["name"] = "Governor",
        ["gov_rpm_filter"] = "RPM Filter Afkap",
        ["gov_pwr_filter"] = "Voltage Filter Afkap",
        ["gov_tta_filter"] = "TTA Bandbreedte",
        ["gov_ff_filter"] = "Precomp Bandbreedte",
        ["gov_d_filter"] = "D-Term Afkap"
      },
      ["accelerometer"] = {
      ...
      ["servos"] = {
        ...
        ["cyc_right"] = "CYC. RIGHT",
        ["help_default_p2"] = "Primaire vluchtbesturingen die gebruikmaken van de inav-mixer worden weergegeven in het gedeelte 'mixer'.",
      ...
      ["fblstatus"] = {
        ...
        ["arming_disable_flag_6"] = "RPM Signaal",
        ["megabyte"] = "MB",
  ...
  ["telemetry"] = {
    ...
    ["group_temps"] = "Temperatuurs",
    ["group_barometer"] = "Barometer",
    ["group_rpm"] = "RPM",
    ["group_attitude"] = "Houding",
    ["group_gyro"] = "Gyroscoop",
    ["group_gps"] = "GPS",
    ["group_load"] = "Systeembelasting",
    ["group_status"] = "Status",
    ["group_profiles"] = "Profielen",
    ["group_tuning"] = "Afstemming",
    ["group_debug"] = "Foutopsporing",
    ["sensor_none"] = "Geen",
    ["sensor_heartbeat"] = "Hartslag",
    ["sensor_battery"] = "Batterij",
    ["sensor_battery_voltage"] = "Battery Spanning",
    ["sensor_battery_current"] = "Battery Stroom",
    ["sensor_battery_consumption"] = "Battery Verbruik",
    ["sensor_battery_charge_level"] = "Battery Laadniveau",
    ...
    ["sensor_collective_control"] = "Collectieve besturing",
    ["sensor_throttle_control"] = "Gas Control",
    ["sensor_esc1_data"] = "ESC1 Gegevens",
    ["sensor_esc1_voltage"] = "ESC1 Spanning",
    ["sensor_esc1_current"] = "ESC1 Stroom",
    ["sensor_esc1_capacity"] = "ESC1 Capaciteit",
    ["sensor_esc1_erpm"] = "ESC1 eRPM",
    ["sensor_esc1_power"] = "ESC1 Vermogen",
    ["sensor_esc1_throttle"] = "ESC1 Gas",
    ["sensor_esc1_temp1"] = "ESC1 Temperatuur 1",
    ["sensor_esc1_temp2"] = "ESC1 Temperatuur 2",
    ...
    ["sensor_esc2_data"] = "ESC2 Gegevens",
    ["sensor_esc2_voltage"] = "ESC2 Spanning",
    ["sensor_esc2_current"] = "ESC2 Stroom",
    ["sensor_esc2_capacity"] = "ESC2 Capaciteit",
    ["sensor_esc2_erpm"] = "ESC2 eRPM",
    ["sensor_esc2_power"] = "ESC2 Vermogen",
    ["sensor_esc2_throttle"] = "ESC2 Gas",
    ["sensor_esc2_temp1"] = "ESC2 Temperatuur 1",
    ["sensor_esc2_temp2"] = "ESC2 Temperatuur 2",
    ...
    ["sensor_esc_voltage"] = "ESC Spanning",
    ["sensor_bec_voltage"] = "BEC Voltage",
    ["sensor_bus_voltage"] = "Bus Voltage",
    ["sensor_mcu_voltage"] = "MCU Voltage",
    ["sensor_esc_current"] = "ESC Stroom",
    ["sensor_bec_current"] = "BEC Current",
    ["sensor_bus_current"] = "Bus Current",
    ["sensor_mcu_current"] = "MCU Current",
    ["sensor_esc_temp"] = "ESC Temperatuur",
    ["sensor_bec_temp"] = "BEC Temperature",
    ["sensor_mcu_temp"] = "MCU Temperature",
    ["sensor_air_temp"] = "Luchttemperatuur",
    ["sensor_motor_temp"] = "Motortemperatuur",
    ["sensor_battery_temp"] = "Batterijtemperatuur",
    ["sensor_exhaust_temp"] = "Uitlaattemperatuur",
    ["sensor_heading"] = "Koers",
    ["sensor_altitude"] = "Hoogte",
    ["sensor_variometer"] = "Variometer",
    ["sensor_headspeed"] = "Koptoerental",
    ...
    ["sensor_gps"] = "GPS",
    ["sensor_gps_sats"] = "GPS Satellieten",
    ["sensor_gps_pdop"] = "GPS PDOP",
    ["sensor_gps_hdop"] = "GPS HDOP",
    ["sensor_gps_vdop"] = "GPS VDOP",
    ["sensor_gps_coord"] = "GPS Coördinaten",
    ["sensor_gps_altitude"] = "GPS Altitude",
    ["sensor_gps_heading"] = "GPS Heading",
    ["sensor_gps_groundspeed"] = "GPS Grondsnelheid",
    ["sensor_gps_home_distance"] = "GPS Afstand naar thuis",
    ["sensor_gps_home_direction"] = "GPS Richting naar thuis",
    ["sensor_gps_date_time"] = "GPS Datum/Tijd",
    ["sensor_load"] = "Load",
    ["sensor_cpu_load"] = "CPU-belasting",
    ["sensor_sys_load"] = "Systeembelasting",
    ["sensor_rt_load"] = "Realtime-belasting",
    ["sensor_model_id"] = "Model-ID",
    ["sensor_flight_mode"] = "Vluchtmodus",
    ["sensor_arming_flags"] = "Armeerindicatoren",
    ["sensor_arming_disable_flags"] = "Uitschakelindicatoren",
    ["sensor_rescue_state"] = "Reddingsstatus",
    ["sensor_governor_state"] = "Governorstatus",
    ["sensor_governor_flags"] = "Governorindicatoren",
    ["sensor_pid_profile"] = "PID-profiel",
    ["sensor_rates_profile"] = "Snelheidsprofiel",
    ["sensor_battery_profile"] = "Batterijprofiel",
    ["sensor_led_profile"] = "LED-profiel",
    ["sensor_adjfunc"] = "Instelbare functie",
    ["sensor_debug_0"] = "Foutopsporing 0",
    ["sensor_debug_1"] = "Foutopsporing 1",
    ["sensor_debug_2"] = "Foutopsporing 2",
    ["sensor_debug_3"] = "Foutopsporing 3",
    ["sensor_debug_4"] = "Foutopsporing 4",
    ["sensor_debug_5"] = "Foutopsporing 5",
    ["sensor_debug_6"] = "Foutopsporing 6",
