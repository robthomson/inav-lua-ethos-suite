...
function developer.wakeup()
    ...
    -- This is an example of how to use the api library to query the governor mode
        inavsuite.utils.log("API Debug Task: GOVERNOR_CONFIG", "info")
    ...
    --[[
    inavsuite.utils.log("API Debug Task: TELEMETRY_CONFIG", "info")
    ...
    if inavsuite.session.mcu_id and inavsuite.config.preferences then
        local iniName = "SCRIPTS:/" .. inavsuite.config.preferences .. "/models/" .. inavsuite.session.mcu_id ..".ini"
        local api = inavsuite.tasks.ini.api.load("api_template")
